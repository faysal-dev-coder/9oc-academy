...
export const NAV_LINKS = [
  ...
  { id: 3, label: "পরীক্ষাসমূহ", href: "/exams" },
  { id: 4, label: "আমাদের সম্পর্কে", href: "/about" },
  { id: 5, label: "যোগাযোগ", href: "/contact" },
];
...
export const TEAM_MEMBERS = [
  {
    id: 1,
    name: "ইঞ্জিনিয়ার মো: ফয়সাল হাসান",
    role: "প্রতিষ্ঠাতা ও CEO",
    bio: "KUET থেকে গ্র্যাজুয়েট। ৭+ বছরের EdTech অভিজ্ঞতা। শিক্ষার ডিজিটাল রূপান্তরে নিবেদিত।",
    avatar: "👨‍💻",
    color: "#1E9CD7",
